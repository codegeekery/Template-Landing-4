...
function FeaturesBlocks() {
  // Refs and useInView hooks for scroll-triggered animations
  const headerRef = useRef(null);
  const blocksRef = useRef(null);
  const isHeaderInView = useInView(headerRef, { once: true });
  const areBlocksInView = useInView(blocksRef, { once: true });
        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Discover how our service simplifies your life. We streamline your tasks with easy-to-use tools, providing seamless integration and support to help you achieve more with less effort.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            ref={blocksRef}
            initial={{ opacity: 0 }}
            animate={{ opacity: areBlocksInView ? 1 : 0 }}
          ...
          >
            ...
            <motion.div
              ...
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: areBlocksInView ? 1 : 0, y: areBlocksInView ? 0 : 50 }}
            ...
            >
              ...
              <p className="text-gray-600 text-center">Get in touch with us to start the conversation</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">We'll discuss your project and how we can help you</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">Explore how our contracting services can bring your project to life</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">Quickly turn your ideas into visual prototypes to guide development.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">Work with our design team to create a beautiful and functional product</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-center">Our development team will bring your project to life and launch it</p>
            </motion.div>
